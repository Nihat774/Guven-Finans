    ...
    <main className=" w-full flex md:flex-row flex-col md:gap-0 gap-5 justify-between items-center py-5 md:py-[50px]">
      <section className="flex flex-col gap-7 items-start md:items-center w-full md:w-[45%]">
        ...
        <form className="flex gap-4">
          <input
            type="text"
            className="w-[200px] md:w-[236px] bg-[#F7F7F7] rounded-tr-lg rounded-bl-lg focus:outline-none placeholder:text-black placeholder:text-[16px] placeholder:font-light p-3 text-[16px] font-light"
